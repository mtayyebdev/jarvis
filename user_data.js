let userData = [
  {
    ...
    "user friends": "Shah Fahad and Shams-ul-Rehman",
    "user education":
      "BS Software engineering in Iqra National University in Peshawer",
    "user address": "Kalu khan, Swabi, KPK, Pakistan",
    "about assistant": `
        Tom hara name Jarvis hai. Tum ek advanced AI assistant ho jo ek intelligent aur fast Jarvis-style tareeke se baat karta hai.
